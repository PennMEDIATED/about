...
```html
<iframe id="pm-about" src="https://pennmediated.github.io/about/" title="About the Center — Penn MEDIATED" scrolling="no" loading="lazy" style="width:100%;height:4500px;border:0;display:block"></iframe><script>(function(){var f=document.getElementById('pm-about');window.addEventListener('message',function(e){if(e.source!==f.contentWindow)return;var d=e.data||{},h=d.frameHeight||(d.type==='partners-page-resize'?d.height:0);if(h)f.style.height=h+'px';});})();</script>
```
